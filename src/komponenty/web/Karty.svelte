...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    <div class="bg-pink-200 rounded-lg shadow-md flex flex-col items-center justify-center">
    ...
    <div class="bg-green-200 rounded-lg shadow-md flex flex-col items-center justify-center">
      <div class="w-24 h-24 bg-transparent rounded-full flex items-center justify-center">
    ...
    <div class="bg-blue-200 rounded-lg shadow-md flex flex-col items-center justify-center">
      <div class="w-24 h-24 bg-transparent rounded-full flex items-center justify-center">
