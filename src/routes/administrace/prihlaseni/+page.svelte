            ...
            <div class="max-w-md mx-auto">
              ...
              <div class="divide-y divide-gray-200">
                <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  ...
                  <div class="relative">
                    <button type="submit" class="bg-green-500 hover:bg-green-800 text-white rounded-md px-2 py-1">Přihlášení</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div class="mt-2">
                    ...
                    <button class="px-4 py-2 bg-gray-800 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-900" on:click={handleCloseModal}>
                      Zavřít
                    </button>
                  </div>
                </div>
